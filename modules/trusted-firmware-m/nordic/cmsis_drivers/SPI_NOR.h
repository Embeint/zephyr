...
#define SPI_NOR_WIP_BIT 0b01 /* Write in progress */
#define SPI_NOR_WEL_BIT 0b10 /* Write enable latch */
...
/* Flags for */
#define NOR_ACCESS_ADDRESSED  (0x01 << 0)
#define NOR_ACCESS_24BIT_ADDR (0x01 << 1)
#define NOR_ACCESS_32BIT_ADDR (0x01 << 2)
#define NOR_ACCESS_WRITE      (0x01 << 7)
