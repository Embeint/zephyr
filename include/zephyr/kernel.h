...
/**
 * @brief Approximation of heap metadata overhead
 *
 ...
 *   End chunk
 *
 * @param bytes Size of the desired heap
 *
 * @retval Approximate size of the metadata consumed by the heap
 */
#define Z_HEAP_OVERHEAD(bytes) (_Z_HEAP_SIZE + _Z_HEAP_BUCKETS_SIZE(bytes) + 8 + 8)
